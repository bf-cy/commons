 ...
 * 从12月1号起计算一年中的假期
 */
public class VacationDayCalculateUtils {
...
//			dates.put("05-02", true);
//			dates.put("05-03", true);
//			dates.put("05-04", true);
//		}else {
//			// 劳动节公历五月一日，放假一天，没有倒休
////			dates.put("05-01", true);
//			// 劳动节公历五月一日，放假一天，有倒休
...
//		cal.setTime(DateUtils.parseString(year + "-12-1 12:00:00", "yyyy-MM-dd hh:mm:ss"));
//		cal.setTime(DateUtils.parseString(year + "-12-1 12:00:00", "yyyy-MM-dd HH:mm:ss"));
		cal.setTime(DateUtils.parseString(year + "-12-1 12:00:00"));
...
//			String date = DateUtils.getStringDateByString(cal.getTime(), "MM-dd");
			String date = DateUtils.formatDate(cal.getTime(), "MM-dd");
			// 这里加入双休
...
//			}
	...
	public String lunar(String year, Integer month, Integer day) {
		...
		calcuLunar(cal, month, day, new LunarUtils(true));
